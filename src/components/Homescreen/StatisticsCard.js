...
export default function SatisticsCard() {
  return(
    <>
      ...
      <View style={{display: 'flex', flexDirection: 'column', width: '100%', padding: 20, backgroundColor: '#343436', borderRadius: 7, marginVertical: 7, shadowColor: '#000000', shadowRadius: 1, shadowOffset: {width: 4, height: 4}, marginBottom: 10}}>
